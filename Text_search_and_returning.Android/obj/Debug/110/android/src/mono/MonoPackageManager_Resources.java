...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Text_search_and_returning.Android.dll" comes first in this list. */
		"Text_search_and_returning.Android.dll",
		"FormsViewGroup.dll",
		"Plugin.Toast.Abstractions.dll",
		"Plugin.Toast.dll",
		"Text_search_and_returning.dll",
